(function() {
  ...
  var CountryFilter = function(input) {
    ...
    this.container = input.closest('.grid-wrapper');
    ...
    $(".conditions-wrapper", this.container).attr("aria-live", "polite");
  ...
  CountryFilter.prototype.filterListItems = function(filter) {
    var countryHeadings = $("div.list", this.container).children("h2"),
        listItems = $("ul.health-list li", this.container),
        itemsToHide,
        itemsShowing,
        synonymMatch = false,
        filterInst = this;
  ...
  CountryFilter.prototype.updateCounter = function (e, eData) {
    var $counter = $(".health-conditions-count", this.container),
        results;
  ...
  $(document).ready(function () {
    $("#conditions-filter form input#country").map(function(idx, input) { 
